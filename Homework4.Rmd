...
To access my GitHub repository, click here: [https://github.com/DanielWu3627/SDS315/tree/main](https://github.com/DanielWu3627/SDS315/tree/main). Please check the file named **Homework4.Rmd**.
...
results <- data.frame(PValue = round(p_values, 3))
results <-cbind(seq(1,10,1), results)
colnames(results) <- c("Sentence", "P-Value")
results
```
