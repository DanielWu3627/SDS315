...
This histogram shows the distribution of course evaluation scores (eval)
...
ggplot(rents) + geom_col(aes(x = weathersit, y = avg_rents)) + facet_wrap(~workingday) + theme_classic() + labs(title = "Average Number of Bike Rentals in Different Weather Conditions According to If It Is a Workday", x = "Weather Status",
    y = "Average Number of Rentals")
```
